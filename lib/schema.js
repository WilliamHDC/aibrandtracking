...
export const projects = pgTable('projects', {
  ...
  brand: text('brand'),
  competitors: jsonb('competitors'), // Changed to jsonb
  brands: jsonb('brands'),          // Changed to jsonb
...
export const analysisResults = pgTable('analysis_results', {
  ...
  projectId: text('project_id').references(() => projects.id),
  topicId: serial('topic_id').references(() => topics.id), // Changed to serial to match topics.id
